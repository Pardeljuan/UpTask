(function () {
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
        ...
        <form class="formulario nueva-tarea">
            ...
            <div class="opciones">
                <input type="submit" class="submit-nueva-tarea" value="${tarea.nombre ? 'Guardar Cambio' : 'Añadir Tarea'}"/>
        ...
        modal.addEventListener('click', function (e) {
            ...
            if (e.target.classList.contains('submit-nueva-tarea')) {
                ...
                if (nombreTarea === '') {
                    ...
                    mostarAlerta('El Nombre de la tarea es Obligatorio', 'error',
    ...
    function mostarAlerta(mensaje, tipo, referencia) {
        ...
        // Previene la acumulacion de alertas 
    ...
    async function agregarTarea(tarea) {
        ...
        try {
            ...
            mostarAlerta(resultado.mensaje, resultado.tipo,
                document.querySelector('.formulario legend'));
    ...
    async function actualizarTarea(tarea) {
        ...
        /* for( let valor of datos.values()){ // codigo para ver el valor por consola
            console.log(valor);
        } */
    }
    ...
    function confirmarEliminarTarea(tarea) {
        Swal.fire({
            title: '¿Seguro que quiere eliminar Tarea?',
