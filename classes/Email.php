...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'f5c6ef143b3d49';
        $mail->Password = 'e0b95fc06c7fc7';
        ...
        UpTask, solo debes confirmar en en siguiente enlace</p>";
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Parece que has olvidado tu password, sigue el siguiente enlace parar recuperarlo</p>";
